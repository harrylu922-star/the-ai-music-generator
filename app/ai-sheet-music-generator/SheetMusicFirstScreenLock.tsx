...
/**
 * 登录状态下仅展示第一屏（Header + 工作区），下方用遮罩锁定；整页 HTML 仍完整输出，不影响 SEO。
 */
export function SheetMusicFirstScreenLock({ children }: { children: React.ReactNode }) {
