...
const sampleTracks = [
  { category: "Full track · Cinematic", title: "Cinematic opener", description: "An epic intro created with our AI music generator for product launches and trailers.", audioSrc: "/audio/sample-cinematic.mp3", coverSrc: "/images/covers/sample-cinematic.webp" },
  { category: "Instrumental · Lo-fi", title: "Lo-fi focus instrumental", description: "A laid-back instrumental you can recreate in one click using our instrumental AI music tool.", audioSrc: "/audio/sample-lofi.mp3", coverSrc: "/images/covers/sample-lofi.webp" },
  { category: "Loop · Background", title: "Loop for talking videos", description: "A subtle loop designed for talking-head videos, generated by the same AI music generator engine.", audioSrc: "/audio/sample-loop.mp3", coverSrc: "/images/covers/sample-loop.webp" },
  { category: "Short clip · Social", title: "15-second social clip", description: "A short, punchy idea you can turn into a full song on the AI music generator page.", audioSrc: "/audio/sample-social.mp3", coverSrc: "/images/covers/sample-social.webp" },
  { category: "Full track · Documentary", title: "Documentary emotional bed", description: "Gentle piano and strings for storytelling and narrative moments.", audioSrc: "/audio/sample-documentary.mp3", coverSrc: "/images/covers/sample-documentary.webp" },
  { category: "Short clip · Vlog", title: "Upbeat vlog intro", description: "Bright acoustic energy for channel or episode openers.", audioSrc: "/audio/sample-vlog.mp3", coverSrc: "/images/covers/sample-vlog.webp" },
  { category: "Instrumental · R&B", title: "Late night R&B groove", description: "Smooth neo-soul vibe for chill or romantic mood.", audioSrc: "/audio/sample-rnb.mp3", coverSrc: "/images/covers/sample-rnb.webp" },
